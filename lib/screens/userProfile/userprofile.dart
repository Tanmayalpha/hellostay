  ...
  Widget build(BuildContext context) {
    return Scaffold(
                     ...
                     // Text("${getUserData?.data.firstName??""} ${getUserData?.data.lastName??""}",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: AppColors.blackTemp),),
                      ...
                      Row(
                        children: [
                          ...
                          Text("${getUserData?.data.email??""}",style: TextStyle(fontSize: 12,color: AppColors.blackTemp),),
      ...
      SizedBox(
          ...
          InkWell(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>ReferAndEranScreen()));
            },
            child: Padding(
              padding: const EdgeInsets.only(left: 15),
              child: Row(
            ...
            onTap: () {
              showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      title: const Text("Confirm Logout",style: TextStyle(color: AppColors.blackTemp,fontWeight: FontWeight.bold),),
                      content: const Text("Are you sure to Logout?",style: TextStyle(fontSize: 20),),
                      actions: <Widget>[
                        ElevatedButton(
